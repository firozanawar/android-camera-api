...
public class PreviewWithScriptGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_with_script_group);
    ...
    private void initScript() {
        ...
        // Set output
        mScriptGroup.setOutput(scriptBlur.getKernelID(), mRgbOutputAlloc);
