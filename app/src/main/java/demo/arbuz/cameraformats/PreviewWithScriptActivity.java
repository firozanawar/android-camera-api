...
public class PreviewWithScriptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_with_script);
    ...
    private void initScript() {
        ...
        mScriptYuvToRGB = ScriptIntrinsicYuvToRGB.create(mRS, Element.U8_4(mRS));
        ...
        mScriptYuvToRGB.setInput(mYuvPreviewAlloc);
    ...
    private void drawFrame(byte[] data, Camera camera) {
        ...
        mScriptYuvToRGB.forEach(mRgbOutputAlloc);
